    ...
    public class MaterialTabSelector : Control, IMaterialControl
    {
        ...
        public MaterialTabControl BaseTabControl
        {
            ...
            set
            {
                ...
                _baseTabControl.ControlAdded += delegate { Invalidate(); };
                _baseTabControl.ControlRemoved += delegate { Invalidate(); };
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                g.DrawString(tabPage.Text.ToUpper(), SkinManager.ROBOTO_MEDIUM_10, textBrush, _tabRects[currentTabIndex], new StringFormat
                {
