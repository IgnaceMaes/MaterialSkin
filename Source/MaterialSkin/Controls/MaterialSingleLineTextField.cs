...
namespace MaterialSkin.Controls
{
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        public string SelectedText
        {
            ...
            set => _baseTextBox.SelectedText = value;
        }

        public int SelectionLength
        {
            get => _baseTextBox.SelectionLength;
            set => _baseTextBox.SelectionLength = value;
        }

        public int SelectionStart
        {
            get => _baseTextBox.SelectionStart;
            set => _baseTextBox.SelectionStart = value;
        }

        public new object Tag
        {
            get => _baseTextBox.Tag;
            set => _baseTextBox.Tag = value;
        }
        ...
        private class BaseTextBox : TextBox
        {
            ...
            {
                BeginInvoke((MethodInvoker) delegate { base.Focus(); });
            }
